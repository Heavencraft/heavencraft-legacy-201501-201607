...
public class ParcheminTourDeGarde implements IParchemin{
	...
	public ItemStack getItem() {
		...
		met.setDisplayName(ChatColor.GREEN + "Portail: la Tour de Garde");
	...
	public void executeParchemin(final RPGPlayer player) {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				player.getPlayer().teleport(new Location(player.getPlayer().getWorld(), -1932, 64, -1179, 91,8));
