...
public class ParcheminTchernocraft implements IParchemin{
	...
	public ItemStack getItem() {
		...
		met.setDisplayName(ChatColor.GREEN + "Portail: Tchernocraft");
	...
	public void executeParchemin(final RPGPlayer player) {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				player.getPlayer().teleport(new Location(player.getPlayer().getWorld(), 4165, 66, 854, 6,-2));
