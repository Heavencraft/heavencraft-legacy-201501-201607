...
public class CreaPermissions
{
	...
	public static final String HIDE_TABCOLOR = "heavencrea.tabcolor.hide";
	public static final String ADMIN_TABCOLOR = "heavencrea.tabcolor.admin";

	public static final String TALENT = CorePermissions.WORLD_ACCESS + WorldsManager.WORLD_TALENT;
	public static final String ARCHITECT = CorePermissions.WORLD_ACCESS + WorldsManager.WORLD_ARCHITECT;
}