...
public class Permission_PermissionsBukkit extends Permission
{
	...
	public boolean playerAdd(String world, String player, String permission)
	{
		...
		return plugin.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
				"permissions player setperm " + player + " " + permission + " true");
	}
	...
	public boolean groupHas(String world, String group, String permission)
	{
		...
		{
			return perms.getGroup(group).getInfo().getWorldPermissions(world).get(permission) == null ? false : perms
					.getGroup(group).getInfo().getWorldPermissions(world).get(permission);
		}
	...
	public boolean groupAdd(String world, String group, String permission)
	{
		...
		return plugin.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
				"permissions group setperm " + group + " " + permission + " true");
	}
	...
	public boolean groupRemove(String world, String group, String permission)
	{
		...
		return plugin.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
				"permissions group unsetperm " + group + " " + permission);
	}
	...
	public boolean playerRemoveGroup(String world, String player, String group)
	{
		...
		return plugin.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(),
				"permissions player removegroup " + player + " " + group);
	}
