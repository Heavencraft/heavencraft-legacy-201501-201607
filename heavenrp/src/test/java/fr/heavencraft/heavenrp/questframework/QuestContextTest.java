...
public class QuestContextTest extends TestCase
{
	public void testQuestContextFlagStore()
	{
		...
		{
			fail("Quest context flag collision detected, but there should not be one.");
		}
		...
		try
		{
			...
			fail("Quest context flag collision NOT detected");
		}
		catch (QuestFlagCollisionException e)
		{
