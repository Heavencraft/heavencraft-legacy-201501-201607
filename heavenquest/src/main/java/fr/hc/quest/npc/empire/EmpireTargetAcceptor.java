...
public class EmpireTargetAcceptor implements TargetAcceptor
{
	public static final TargetAcceptor INSTANCE = new EmpireTargetAcceptor();
	...
	public boolean accept(Entity target)
	{
		...
		return targetNPC.getTeam() == Team.CITADEL;
	}
}